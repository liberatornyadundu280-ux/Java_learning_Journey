public class java_loops_input_output_stringtypecasting {
    public static void main(String[] args) {
        ...
        System.out.printf("%-15s%03d%n", name, sum);// this is used to left pad 3 when the number does not reach 3 and
                                                    // also makes some space on the ryt of the string to separate it
